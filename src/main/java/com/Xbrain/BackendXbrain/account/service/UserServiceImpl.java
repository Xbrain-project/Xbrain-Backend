...
public class UserServiceImpl implements UserService{
    ...
    public User save(UserRegistrationDto registrationDto) {
        ...
        registrationDto.getEmail(), passwordEncoder.encode(registrationDto.getPassword()), registrationDto.getPhone(), 
        registrationDto.getClasses(), Arrays.asList(new Role("ROLE_USER")));
